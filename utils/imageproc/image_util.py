    ...
    while (
        ...
        for x in range(1, rows - 1):  # No. of  rows
            for y in range(1, columns - 1):  # No. of columns
                p2, p3, p4, p5, p6, p7, p8, p9 = n = neighbours_1(x, y, image_thinned)
                if (
                    (
                        image_thinned[x][y] == 1
                    ).all()  # Condition 0: Point p1 in the object regions
                    and 2 <= sum(n) <= 6  # Condition 1: 2<= N(p1) <= 6
                    and transitions(n) == 1  # Condition 2: S(p1)=1
        ...
        for x in range(1, rows - 1):
            for y in range(1, columns - 1):
                p2, p3, p4, p5, p6, p7, p8, p9 = n = neighbours_1(x, y, image_thinned)
                if (
                    (image_thinned[x][y] == 1).all()  # Condition 0
