...
ax[2].set_title(' MSE:' +"{0:.5f}".format(mse_squared_art_tort) + "r2score:" +"{0:.5f}".format(r2_squared_art_tort))
...
ax[3].set_title(' MSE:' +"{0:.5f}".format(mse_distance_art_tort) + "r2score:" +"{0:.5f}".format(r2_distance_art_tort))
...
ax[4].set_title(' MSE:' +"{0:.5f}".format(mse_linear_reg_art_tort) + "r2score:" +"{0:.5f}".format(r2_linear_reg_art_tort))
...
ax[5].set_title(' MSE:' +"{0:.5f}".format(mse_vti) + "r2score:" +"{0:.5f}".format(r2_vti))
...
ax[6].set_title(' MSE:' +"{0:.5f}".format(mse_vti_mat) + "r2score:" +"{0:.5f}".format(r2_vti_mat))
