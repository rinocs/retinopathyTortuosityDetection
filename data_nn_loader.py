...
x_all, y_all = dataprepare.read_all_data_v2(allPath,  h,w)
...
np.save('x_all_'+str( h)+'_'+str(w)+'_v2_nono_dt.npy', x_all)
np.save('y_all_'+str( h)+'_'+str(w)+'_v2_nono_dt.npy', y_all)
